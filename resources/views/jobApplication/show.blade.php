                    ...
                    <div class="row">
                        ...
                        <div class="col text-end">
                            @can('Create Interview Schedule')
                                <a data-url="{{ route('interview-schedules.create', $jobApplication->id) }}" data-size="lg"
                                    class="btn-sm btn btn-primary" data-ajax-popup="true"
                                    ...
                                    @can('Delete Job Application Note')
                                        @if ($note->note_created == \Auth::user()->id)
                                            <div class="col-auto text-end">
                                                ...
                                                <a href="#"
                                                    class="mx-3 btn btn-sm btn btn-danger  align-items-center bs-pass-para"
