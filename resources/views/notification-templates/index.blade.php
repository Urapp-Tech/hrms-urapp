                        ...
                        <li class="dropdown dash-h-item drp-language">
                            ...
                            <div class="dropdown-menu dash-h-dropdown dropdown-menu-end" aria-labelledby="dropdownLanguage">
                                @foreach (App\Models\Utility::languages() as $code => $lang)
                                    <a href="{{ route('notifications-templates.index', [$notification_template->id, $code]) }}"
                        ...
                        <li class="dropdown dash-h-item drp-language">
                            ...
                            <div class="dropdown-menu dash-h-dropdown dropdown-menu-end email_temp"
                                ...
                                @foreach ($notification_templates as $notification)
                                    <a href="{{ route('notifications-templates.index', [$notification->id, Request::segment(3) ? Request::segment(3) : \Auth::user()->lang]) }}"
